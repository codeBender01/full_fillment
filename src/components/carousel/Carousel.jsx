...
function Carousel() {
  return (
    <FadeIn from="left" positionOffset={1000} triggerOffset={1000}>
            ...
            <div className="welcome-text flex item" key={num}>
              <div>
                ...
                <p>
                  ...
                  veniam, vel facilisi. volutpat. dolor nonummy minim qui wisi
                  in euismod dignissim lobortis suscipit aliquip elit, odio vel
